...
public enum LegacyHotkeyPolicy {
    ...
    public static let legacyShortcutCancelLayoutChangeKey = "shortcutCancelLayoutChange"
    public static let legacyShortcutFindInYandexKey = "shortcutFindInYandex"
    public static let legacyShortcutFindInSlovariKey = "shortcutFindInSlovari"
    public static let legacyCancelLayoutChangeShortcutKey = "cancelLayoutChangeShortcut"
    public static let legacySwitchAutocorrectionShortcutKey = "switchAutocorrectionShortcut"
    public static let legacyChangeCaseShortcutKey = "changeCaseShortcut"
